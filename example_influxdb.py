...
if __name__ == "__main__":
    ...
    argparser.add_argument("--influx_host", type=str, help="Influx host")
    argparser.add_argument("--influx_port", default=8086, type=int, help="Influx port")
    argparser.add_argument("--influx_db", default="solaredge", type=str, help="Influx port")
    argparser.add_argument("--user", type=int, help="Influx user")
    argparser.add_argument("--pass", type=int, help="Influx pass")
